...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="/dashboard/senibudaya">{{ $title }}</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="mt-2 card-head d-flex justify-content-between align-items-center">
                        <h4 class="m-0">Daftar Seni dan Budaya</h4>
                        <a href="/dashboard/senibudaya/create" class="btn btn-icon icon-left btn-primary ml-auto">
                                ...
                                <tbody>
                                    @foreach ($senibudaya as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="/dashboard/senibudaya/{{ $item->slug }}/edit"
                                                    class="btn btn-success" data-toggle="tooltip" data-placement="top"
                                                    title="Ubah"><i class="fas fa-edit"></i></a>
                                                <form action="/dashboard/senibudaya/{{ $item->slug }}" method="POST"
