...
@section('content')
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="/dashboard/kategori">Kategori</a></div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form id="filterForm" action="/dashboard/kategori/{{ $kategori->slug }}" method='post'
                    ...
                    <div class="form-group">
                        @if ($kategori->gambar)
                            <img src="{{ asset('storage/' . $kategori->gambar) }}" alt="Current Image" width="250px"
