...
@section('content')
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form id="filterForm" action="/dashboard/kuliner/{{ $kuliner->slug }}" method='post'
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control"
                            value="{{ old('nama', $kuliner->nama) }}" required autofocus>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="deskripsi" name="deskripsi" class="form-control"
                            value="{{ old('deskripsi', $kuliner->deskripsi) }}" required autofocus>
                        @error('deskripsi')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        @if ($kuliner->gambar)
                            <img src="{{ asset('storage/' . $kuliner->gambar) }}" alt="Current Image" width="250px"
